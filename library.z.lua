...
if theme == 'dark' then
    ...
    DTTransparency = 0.6
      ...
      DropShadow.Image = "rbxassetid://129730643106950"--UI背景
      ...
      ScriptTitle.TextColor3 = UIGradient.Color
    ...
    coroutine.wrap(NPLHKB_fake_script)()
      ...
      Open.Text = "隐藏/打开"--可以改
      Open.TextColor3 = UIGradient.Color
      Open.TextSize = 14.000
      Open.Active = true
      Open.Draggable = true
      Open.MouseButton1Click:Connect(function()
          Main.Visible = not Main.Visible
          Open.Text=Main.Visible and "隐藏" or "打开"--可以改
      end)
      UIG.Parent = Open
      local window = {}
      function window.Tab(window, name, icon)
        ...
        TabText.Text = name
        TabText.TextColor3 = UIGradient.Color
        ...
        TabBtn.Text = ""
        TabBtn.TextColor3 = UIGradient.Color
        ...
        function tab.section(tab, name, TabVal)
          ...
          SectionText.TextColor3 = UIGradient.Color
          ...
          function section.Button(section, text, callback)
            ...
            Btn.Text = "   " .. text
            Btn.TextColor3 = UIGradient.Color
            Btn.TextSize = 16.000
        ...
        function section:Label(text)
          ...
          TextLabel.Text = text
          TextLabel.TextColor3 = UIGradient.Color
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            ToggleBtn.Text = "   " .. text
            ToggleBtn.TextColor3 = UIGradient.Color
          ...
          function section.Keybind(section, text, default, callback)
            ...
            KeybindBtn.TextColor3 = UIGradient.Color
            ...
            KeybindValue.TextColor3 = UIGradient.Color
          ...
          function section.Textbox(section, text, flag, default, callback)
            ...
            TextboxBack.TextColor3 = UIGradient.Color
            ...
            BoxBG.Text = ""
            BoxBG.TextColor3 = UIGradient.Color
            ...
            TextBox.TextColor3 = UIGradient.Color
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            SliderBack.TextColor3 = UIGradient.Color
            ...
            SliderValBG.Text = ""
            SliderValBG.TextColor3 = UIGradient.Color
            ...
            SliderValue.TextColor3 = UIGradient.Color
            ...
            MinSlider.Text = "-"
            MinSlider.TextColor3 = UIGradient.Color
            ...
            AddSlider.Text = "+"
            AddSlider.TextColor3 = UIGradient.Color
          ...
          function section.Dropdown(section, text, flag, options, callback)
            ...
            DropdownTop.Text = ""
            DropdownTop.TextColor3 = UIGradient.Color
            ...
            DropdownOpen.Text = "+"
            DropdownOpen.TextColor3 = UIGradient.Color
            ...
            DropdownText.Text = ""
            DropdownText.TextColor3 = UIGradient.Color
            ...
            funcs.AddOption = function(self, option)
              ...
              Option.Text = option
              Option.TextColor3 = UIGradient.Color
